...
if (!function_exists('chromenews_athfb_add_custom_admin_menu')) {

    function chromenews_athfb_add_custom_admin_menu($wp_admin_bar)
    {
      ...
      $parent_title  = $afthemes_icon . esc_html__('ChromeNews Options', 'chromenews');
  
      // Add parent menu
      $wp_admin_bar->add_menu(array(
        'id'    => 'chromenews-menu',
        'title' => $parent_title,
        'href'  => admin_url('admin.php?page=chromenews-pro'),
        'meta'  => array(
          'title'  => esc_attr__('ChromeNews Options', 'chromenews'), // Tooltip
    ...
    add_action('admin_bar_menu', 'chromenews_athfb_add_custom_admin_menu', 100);
    add_action('admin_enqueue_scripts', 'chromenews_admin_bar_styling');
    add_action('wp_enqueue_scripts', 'chromenews_admin_bar_styling'); // Also in frontend if admin bar visible
  
    function chromenews_admin_bar_styling()
    {
      if (is_admin_bar_showing()) {
        wp_add_inline_style(
          ...
          #wpadminbar #wp-admin-bar-chromenews-menu > .ab-item {
          ...
          #wpadminbar #wp-admin-bar-chromenews-menu > .ab-item:hover,
          #wpadminbar #wp-admin-bar-chromenews-menu.hover > .ab-item,
          #wpadminbar #wp-admin-bar-chromenews-menu > .ab-item:focus,
          #wpadminbar #wp-admin-bar-chromenews-menu > .ab-item:active {
              background-color: #006eb8 !important;
              color: #fff !important;
          }
  
          /* Visited state (rarely used in admin bar) */
          #wpadminbar #wp-admin-bar-chromenews-menu > .ab-item:visited {
              color: #fff !important;
          }
  
          /* Icon alignment */
          // #wpadminbar #wp-admin-bar-chromenews-menu img {
          //     vertical-align: middle;
          //     margin-right: 4px;
          //     color: #fff !important;
          // }
          #wpadminbar #wp-admin-bar-chromenews-menu svg {
            height:20px;
            width: 20px;
            fill: #fff;
            color: #fff;
        ...
        #wpadminbar #wp-admin-bar-chromenews-menu:hover svg {
            fill: #ffcc00;
        }
