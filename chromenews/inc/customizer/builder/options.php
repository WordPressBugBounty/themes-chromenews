    ...
    return json_encode(array(
      'footer_desktop_items' => array(
        'top' => array(
          ...
          'top_center' => array('footer_widget_2'),
          'top_right' => array('footer_widget_3'),
        ),
        'main' => array(
...
if (!function_exists('get_available_blocks')) {
  function get_available_blocks()
  {
    return array(
      'header_logo' => array(
        'label' => esc_html__('Site & Logo', 'chromenews'),
        'icon' => 'dashicons-format-image',
        'elfocus' => 'athfb_show_checkbox_header',
        'settings' => array(

          'site_msg' => array(
            'label' => esc_html__('Site Identity', 'chromenews'),
            'type' => 'hidden', // important
            'sanitize' => 'sanitize_text_field',
            'description' => sprintf(
              /* translators: %s is a link to Site Identity panel */
              __('You can change Site Identity from %s.', 'chromenews'),
              '<a href="#" class="athfb-widget-panel-link" data-panel="title_tagline">' . esc_html__('Site Identity', 'chromenews') . '</a>'
            ),
          )
        ),
      ),
      ...
      'header_promotion' => array(
        'label' => esc_html__('Promotion', 'chromenews'),
      ...
      'header_off_canvas' => array(
        'label' => esc_html__('Off Canvas', 'chromenews'),
        'icon'  => 'dashicons-welcome-widgets-menus',
        'elfocus' => 'athfb_show_checkbox_header',
        'settings' => array(
          'widget_area' => array(
            'label'       => esc_html__('Off Canvas Widget Area', 'chromenews'),
            'type'        => 'hidden',
            'value'       => 'express-off-canvas-panel',
            'sanitize' => 'sanitize_text_field',
            'description' => sprintf(
              __('This widget area is used in the mobile off-canvas panel. %s', 'chromenews'),
              '<a href="#" class="athfb-widget-panel-link" data-panel="sidebar-widgets-express-off-canvas-panel">' . esc_html__('Manage widgets', 'chromenews') . '</a>'
            ),
          ),
        ),
      ),
      ...
      'header_navigation' => array(
        'label' => esc_html__('Primary menu', 'chromenews'),
        'icon' => 'dashicons-menu',
        'elfocus' => 'athfb_show_checkbox_header',
        'settings' => array(
          'menu_id' => array(
            'label' => esc_html__('Select Menu', 'chromenews'),
            'type' => 'hidden',
            ...
            'description' => sprintf(
              ...
              __('You can change Menu from menu panel. %s', 'chromenews'),
              '<a href="#" class="athfb-widget-panel-link" data-panel="menu_locations">' . esc_html__('Manage menu', 'chromenews') . '</a>'
            ),
          ),
        ),
      ),
      'header_date' => array(
        'label' => esc_html__('Date', 'chromenews'),
        'icon' => 'dashicons-calendar',
        'elfocus' => 'athfb_show_checkbox_header',
        'settings' => array(
          'placeholder' => array(
            'label' => esc_html__('Choose date format', 'chromenews'),
            'type' => 'hidden', // important
            ...
            'description' => sprintf(
              /* translators: %s is a link to manage menus */
              __('You can change date from general settings (Settings > General > Date Format). %s', 'chromenews'),
              '<a href="' . esc_url(admin_url('options-general.php')) . '">' . esc_html__('Manage Date', 'chromenews') . '</a>'
            ),
          ),
        ),
      ),
      'header_top_navigation' => array(
        'label' => esc_html__('Top Navigation', 'chromenews'),
        'icon' => 'dashicons-menu',
        'elfocus' => 'athfb_show_checkbox_header',
        'settings' => array(
          'menu_id' => array(
            ...
            'is_lock' => true,
            'lock_msg' => __('pro', 'chromenews')

          ),
        ),
      ),
      'header_site_mode' => array(
        'label' => esc_html__('Site Mode', 'chromenews'),
      ...
      'header_html' => array(
        'label' => esc_html__('Custom HTML', 'chromenews'),
        'icon' => 'dashicons-editor-code',
        'elfocus' => 'athfb_show_checkbox_header',
        'settings' => array(
          'custom_html' => array(
            'label' => esc_html__('HTML Content', 'chromenews'),
            'type' => 'hidden',
            'default' => '',
            'sanitize' => 'chromenews_sanitize_custom_html',
            'is_lock' => true,
            'lock_msg' => __('pro', 'chromenews')
      ...
      'header_search' => array(
        'label' => esc_html__('Search', 'chromenews'),
        'icon' => 'dashicons-search',
        'elfocus' => 'athfb_show_checkbox_header',
        'settings' => array(
          'placeholder' => array(
            'label' => esc_html__('Searc Form', 'chromenews'),
            'type' => 'hidden',
            'sanitize' => 'sanitize_text_field',
      ...
      'header_button' => array(
        'label' => esc_html__('Custom Link', 'chromenews'),
      ...
      'header_widget_1' => array(
        'label' => esc_html__('Widget 1', 'chromenews'),
        'icon' => 'dashicons-menu-alt',
        'elfocus' => 'athfb_show_checkbox_header',
        'settings' => array(
          'widget' => array(
            'label' => esc_html__('Select Widget', 'chromenews'),
            'type' => 'hidden',
      ...
      'header_widget_2' => array(
        'label' => esc_html__('Widget 2', 'chromenews'),
        'icon' => 'dashicons-menu-alt',
        'elfocus' => 'athfb_show_checkbox_header',
        'settings' => array(
          'widget' => array(
      ...
      'header_widget_3' => array(
        'label' => esc_html__('Widget 3', 'chromenews'),
        'icon' => 'dashicons-menu-alt',
        'elfocus' => 'athfb_show_checkbox_header',
        'settings' => array(
          'widget' => array(
  ...
  function athfb_get_footer_available_blocks()
  {
    return array(
      'footer_navigation' => array(
        'label' => esc_html__('Navigation', 'chromenews'),
        'icon' => 'dashicons-menu',
      ...
      'footer_copyright' => array(
        'label' => esc_html__('Copyright', 'chromenews'),
      ...
      'footer_widget_1' => array(
        ...
        'settings' => array(
          'widget' => array(
            ...
            'sanitize' => 'sanitize_text_field',
            'description' => sprintf(
              __('Add widget to display . %s', 'chromenews'),
              '<a href="#" class="athfb-widget-panel-link" data-panel="sidebar-widgets-footer-first-widgets-section">' . esc_html__('Manage widgets', 'chromenews') . '</a>'
            ),
          ),
        ),
      ),
      'footer_widget_2' => array(
        ...
        'settings' => array(
          'widget' => array(
            ...
            'description' => sprintf(
              __('Add widget to display . %s', 'chromenews'),
              '<a href="#" class="athfb-widget-panel-link" data-panel="sidebar-widgets-footer-second-widgets-section">' . esc_html__('Manage widgets', 'chromenews') . '</a>'
            ),
      ...
      'footer_widget_3' => array(
        ...
        'settings' => array(
          'widget' => array(
            ...
            'description' => sprintf(
              __('Add widget to display . %s', 'chromenews'),
              '<a href="#" class="athfb-widget-panel-link" data-panel="sidebar-widgets-footer-third-widgets-section">' . esc_html__('Manage widgets', 'chromenews') . '</a>'
            ),
            // 'is_lock' => true,
            // 'lock_msg' => __('pro', 'chromenews')
          ),
...
if (!function_exists('athfb_get_nav_menus')) {
  function athfb_get_nav_menus()
  {
    ...
    $choices   = array('' => esc_html__('Select Menu', 'chromenews'));
    ...
    foreach ($locations as $location_key => $label) {
      $menu_name = esc_html__('No menu assigned', 'chromenews');
...
function athfb_get_all_registered_widgets()
{
  ...
  foreach ($wp_registered_sidebars as $sidebar) {
    ...
    //if (strpos($sidebar['description'], 'chromenews') !== false || strpos($sidebar['id'], 'home-') === 0 || strpos($sidebar['id'], 'single-') === 0 || strpos($sidebar['id'], 'footer-') === 0) {
...
if (!function_exists('chromenews_has_value_recursive')) {
  function chromenews_has_value_recursive($array, $value)
  {
    foreach ($array as $item) {
      if ($item === $value) {
        return true;
      }
      if (is_array($item) && chromenews_has_value_recursive($item, $value)) {
        return true;
      }
    }
    return false;
